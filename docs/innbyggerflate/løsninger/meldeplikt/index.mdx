...
Dependabot oppretter pull request'er og utviklere må merge disse PRene til master, sjekke at appene bygges og alt fungerer i Q1/Q2, deretter opprette release og deploye til prod.
